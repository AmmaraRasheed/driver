 ...
 */
public class DenyStudentFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v= inflater.inflate(R.layout.fragment_deny_student, container, false);
        databaseReference = FirebaseDatabase.getInstance().getReference("Student");
        recyclerView = (RecyclerView)v. findViewById(R.id.deny_recycle);
